...
"ÅöçÌèú	nnoremap <silent> <leader>* :call <sid>SearchCurrentMark()<cr>
"ÅöçÌèú	nnoremap <silent> <leader># :call <sid>SearchCurrentMark("b")<cr>
"ÅöçÌèú	nnoremap <silent> <leader>/ :call <sid>SearchAnyMark()<cr>
"ÅöçÌèú	nnoremap <silent> <leader>? :call <sid>SearchAnyMark("b")<cr>
"ÅöçÌèú	nnoremap <silent> * :if !<sid>SearchNext()<bar>execute "norm! *"<bar>endif<cr>
"ÅöçÌèú	nnoremap <silent> # :if !<sid>SearchNext("b")<bar>execute "norm! #"<bar>endif<cr>
